# Training Gradient Boosting models to predict Tg
# Version: 2025.10.22
...
feature_gen.save('Features_Tg2.pkl')
...
config.disp_metrics(train_metrics, valid_metrics, f"{model_name} model Tg")
...
plotter.plot(true_Tg_plot, pred_Tg_plot, plot_is_train,
             ...
             unit='(°C)',
             title=r'Parity Plot for Glass Transition Temperature (T$_g$) with ' + model_name,
